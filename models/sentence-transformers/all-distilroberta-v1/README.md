...
widget:
- source_sentence: spacetime.com
  sentences:
  - learn-desktoptrzor.webflow.io
  - conti-casino.ro
  - damcom.com.br
- source_sentence: shivering.world
  sentences:
  - myfusfun.fun
  - bungalibaba.com
  - myslsamodzielnie.lat
- source_sentence: marcusessentials.com
  sentences:
  - dcshoes-chile.com
  - q2ufi4.duckdns.org
  - usaa.ns01.info
- source_sentence: ukraine-furniture.com.ua
  sentences:
  - zjc.bz
  - dgap.de
  - polina.me
- source_sentence: asocity-kanko.jp
  sentences:
  - profi-pl.tilda.ws
  - wy086.com
  - proflist-nsk.ru
...
print(similarities)
# tensor([[ 1.0000,  0.3154, -0.0757],
#         [ 0.3154,  1.0000, -0.0263],
#         [-0.0757, -0.0263,  1.0000]])
```
...
* Approximate statistics based on the first 1000 samples:
  ...
  |:--------|:---------------------------------------------------------------------------------|:---------------------------------------------------------------------------------|
  | type    | string                                                                           | string                                                                           |
  | details | <ul><li>min: 5 tokens</li><li>mean: 9.12 tokens</li><li>max: 31 tokens</li></ul> | <ul><li>min: 5 tokens</li><li>mean: 9.31 tokens</li><li>max: 34 tokens</li></ul> |
* Samples:
  | sentence_0                       | sentence_1                       |
  |:---------------------------------|:---------------------------------|
  | <code>thuathienhue.gov.vn</code> | <code>drogeriapigment.pl</code>  |
  | <code>jeelenes.com</code>        | <code>tokyo-motorshow.com</code> |
  | <code>superhost.pl</code>        | <code>theironmaidens.com</code>  |
